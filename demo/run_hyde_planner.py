...
async def run_hyde_planner(env: Environment, model: str, query: str, time_period: str, search_depth: str, use_jina_api: bool, search_pdfs: bool, pdf_processing_method: str, use_arxiv: bool, use_finance: bool, log_data: dict):
...
async def run_sequential_reflection_search(env: Environment, model: str, query: str, time_period: str, use_jina_api: bool, search_pdfs: bool, pdf_processing_method: str, use_arxiv: bool, use_finance: bool, log_data: dict):
    ...
    with st.spinner("Running Sequential-Reflection Search... This may take several steps."):
        ...
        for i in range(5): # Limit steps
            prompt = get_reflection_prompt(query, conversation_history, use_arxiv=use_arxiv, use_finance=use_finance)
            response_text, p, c = await call_llm(env, model, prompt)
            tracking["prompt_tokens"] += p; tracking["completion_tokens"] += c
...
async def run_priority_hyde_planner(env: Environment, model: str, query: str, time_period: str, search_depth: str, use_jina_api: bool, search_pdfs: bool, pdf_processing_method: str, use_arxiv: bool, use_finance: bool, log_data: dict):
...
async def run_2step_hyde_planner(env: Environment, model: str, query: str, time_period: str, replan_depth: str, use_jina_api: bool, search_pdfs: bool, pdf_processing_method: str, use_arxiv: bool, use_finance: bool, log_data: dict):
...
async def run_hyde_planner_with_reflection(env: Environment, model: str, query: str, time_period: str, search_depth: str, use_jina_api: bool, search_pdfs: bool, pdf_processing_method: str, use_arxiv: bool, use_finance: bool, log_data: dict):
...
async def phase_2_reverse_engineer_plan(env: Environment, model: str, doc: str, use_arxiv: bool, use_finance: bool) -> Tuple[dict, int, int]:
    st.info("Phase 2: Reverse-Engineering Research Plan...")
    prompt = get_plan_reverse_engineering_prompt(doc, use_arxiv=use_arxiv, use_finance=use_finance)
...
def phase_3_execute_plan_and_verify(env: Environment, plan: dict, time_period: str, search_depth: str, use_jina_api: bool, search_pdfs: bool, pdf_processing_method: str, use_arxiv: bool, use_finance: bool) -> dict:
    st.info("Phase 3: Executing Plan and Verifying Claims...")
    evidence = {}
    
    # Combine both verification and exploratory claims into one list to execute
    ...
    if st.sidebar.button("Run", use_container_width=True):
        ...
        for methodology in methods_to_run:
            ...
            if methodology == "HyDE-Planner":
                ...
                args.extend([search_depth, use_jina_api, search_pdfs, pdf_processing_method, use_arxiv, use_finance, log_data])
                ...
                args.extend([replan_depth, use_jina_api, search_pdfs, pdf_processing_method, use_arxiv, use_finance, log_data])
